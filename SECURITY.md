...
disabled/fail-closed by default. An explicit non-production activation path has owner-authorized alternative external Linux READ acceptance
evidence for `main@2f9ab7fdfe8793a9b2c977bc620c0f10921f4e3f`; official GitHub Actions parity remains pending due account-level Actions
policy. Provider WRITE remains blocked.
